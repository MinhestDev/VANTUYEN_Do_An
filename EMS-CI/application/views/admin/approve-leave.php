  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Đồng ý nghỉ phép</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Đồng ý nghỉ phép</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url(); ?>leave-approved/<?php echo $cnt['id']; ?>" class="btn btn-success">Đồng ý</a>
                          <a href="<?php echo base_url(); ?>leave-rejected/<?php echo $cnt['id']; ?>" class="btn btn-danger">Từ chối</a>
                        </td>
                      </tr>
                    <?php 
                      $i++;
