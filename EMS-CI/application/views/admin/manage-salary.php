        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Quản lý lương</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        ...
                        <td><a href="<?php echo base_url(); ?>salary-invoice/<?php echo $cnt['id']; ?>" class="btn btn-warning">Hóa đơn</a></td>
                        <td>
                          <a href="<?php echo base_url(); ?>delete-salary/<?php echo $cnt['id']; ?>" class="btn btn-danger">Xóa</a>
                        </td>
                      </tr>
                    <?php 
                      $i++;
